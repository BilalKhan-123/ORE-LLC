...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ __('messages.departments') }} | {{ config('site.siteTitle') }}</title>
                        ...
                        @forelse($data['departments'] as $key => $department)
                            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="{{ ($key % 3) * 100 + 100 }}">
                                <div class="service-item position-relative">
                                    ...
                                    <a href="{{ route('site.departments.details', $department->slug) }}" class="stretched-link">
                                        <h3>{{ $department->title }}</h3>
                                        @if($department->is_featured) <small class="badge bg-success rounded-pill"">{{ __('messages.featured') }}</small>@endif

                                    </a>
                                    <p>{{ $department->sub_title ?? '' }}</p>
                                </div>
