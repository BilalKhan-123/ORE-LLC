                    ...
                    <div class="container">
                        <div class="row gy-4">
                            ...
                            @if(!empty($data['about']->description))
                                    ...
                                    <div class="about-description py-3">
                                        {!! $description !!}
                                    </div>
                            ...
                            <div class="col-lg-4 position-relative align-self-start" data-aos="fade-up" data-aos-delay="100">
                                @if($data['about']->main_image)
                                    ...
                                    <img src="{{ asset('storage/'.$data['about']->main_image) }}" class="img-fluid" alt="About Image" width="400" height="400" >
                                @else
                                    <img src="assets/img/about.jpg" class="img-fluid" alt="" width="400" height="400" >
                                @endif
