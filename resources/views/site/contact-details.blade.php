...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ __('messages.contact') }} | {{ config('site.siteTitle') }}</title>
              ...
              <div class="heading">
                <div class="container">
                  <div class="row d-flex justify-content-center text-center">
                    <div class="col-lg-8">
                      <h1 class="heading-title">{{ __('messages.contact') }}</h1>
                      <p class="mb-0">
                          {{-- {{$data['serviceDetails']->sub_title ?? ''}} --}}
                          {{ __('messages.tag_contact') }}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <nav class="breadcrumbs">
                <div class="container">
                  <ol>
                    ...
                    <li class="current active">{{ __('messages.contact') }}</li>
                  </ol>
                </div>
              </nav>
            </div><!-- End Page Title -->
