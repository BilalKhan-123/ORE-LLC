...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
            ...
            <div class="max-w-7xl mx-auto p-12 lg:p-8">
                <div class="flex justify-center">
                    <div class="bg-white dark:bg-gray-800 shadow-2xl rounded-lg p-8 w-full max-w-md">
                        <h2 class="text-2xl font-semibold text-center text-gray-900 dark:text-white mb-2">
                            Reset Your Password
                        </h2>
                        <p class="text-sm text-center text-gray-600 dark:text-gray-400 mb-8">
                        ...
                        <div class="mt-6 text-center space-y-2">
                            <p class="text-sm text-gray-600 dark:text-gray-400">
                                ...
                                <a href="{{ route('admin.login') }}" class="text-red-500 hover:text-red-600 font-semibold">Login here</a>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <script>
            ...
            document.getElementById('email').addEventListener('focus', clearMessages);
                ...
                try {
                    ...
                    if (response.ok) {
                        ...
                        if (data.errors) {
                            ...
                            showErrorMessage(data.message || 'Validation error occurred');
                        }
                    } else if (response.status === 404) {
                        // Email not found
                        showErrorMessage(data.message || 'Email address not found');
                    } else {
                        // Other errors
            ...
            function showValidationErrors(errors) {
                ...
                Object.keys(errors).forEach(field => {
                    ...
                    const fieldErrorSpan = document.getElementById(`${field}-error`);
                    if (fieldErrorSpan) {
                        fieldErrorSpan.textContent = errorMessage;
                        fieldErrorSpan.classList.remove('hidden');
                        
                        // Add error styling to input
                        const field_element = document.getElementById(field);
                        if (field_element) {
                            field_element.classList.add('border-red-500', 'focus:outline-red-500');
                        }
                    }
                });
            ...
            function clearMessages() {
                ...
                document.querySelectorAll('input').forEach(input => {
                    ...
                    input.classList.add('border-gray-300', 'focus:outline-red-500');
                });
            }
