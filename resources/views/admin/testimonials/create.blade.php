...
<div class="container-fluid mt-4">
    <div class="row mb-4">
        <div class="col-md-8">
            <h1>{{ __('messages.create_testimonial') ?? 'Create Testimonial' }}</h1>
        </div>
        ...
        <div class="card-body">
            <form action="{{ route('admin.testimonials.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control rte-editor @error('description') is-invalid @enderror" id="description" name="description" rows="6" required>{{ old('description') }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('designation') is-invalid @enderror" id="designation" name="designation" value="{{ old('designation') }}" placeholder="e.g., CEO, Manager">
                    @error('designation')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('company') is-invalid @enderror" id="company" name="company" value="{{ old('company') }}" placeholder="e.g., ABC Company">
                    @error('company')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3 form-check">
                    <input type="checkbox" class="form-check-input" id="is_show" name="is_show" value="1" {{ old('is_show') ? 'checked' : '' }}>
